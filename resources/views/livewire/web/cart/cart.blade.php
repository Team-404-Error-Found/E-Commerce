<div class="bg-gray-100 min-h-screen p-6">
    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white shadow-md rounded-lg p-4">

            <h2 class="text-xl font-semibold border-b pb-3">Flipkart</h2>

            <!-- Address -->
            <div class="flex flex-col md:flex-row justify-between items-center p-3 bg-gray-100 mt-4 rounded-md">
                <p class="text-gray-700 font-medium text-center md:text-left">
                    Deliver to: <span class="font-bold">$address</span>
                </p>
                <button class="text-blue-600 font-semibold mt-2 md:mt-0">Change</button>
            </div>

            <!-- Cart Item -->
            <div class="flex flex-col md:flex-row border-b py-4 items-center">
                <img src="#" class="w-24 h-24 object-cover rounded-md" alt="Product">
                <div class="ml-0 md:ml-4 flex-1 text-center md:text-left">
                ...
                <button class="text-red-500 font-semibold mt-2 md:mt-0">Remove</button>
            </div>
            ...
            <div class="bg-blue-100 p-3 rounded-lg mt-4">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <button class="bg-yellow-500 text-white px-4 py-2 rounded-md mt-2 md:mt-0">Add Item</button>
                </div>
            </div>
